...
The Harvest Design System is based on [MUI](https://mui.com/):
...
Harvest takes the Design Tokens as in [MUI Theme Configuration Variables](https://mui.com/customization/theming/#theme-configuration-variables)
...
Harvest comes with +40 components to get started, in 7 categories:
